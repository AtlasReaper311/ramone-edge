...
.error-header .atlas-global-header__link{padding:0;font-size:12px;letter-spacing:.06em;text-transform:uppercase}
...
@media(max-width:767px){.error-header{grid-template-columns:minmax(0,1fr)}.error-header .atlas-global-header__nav{display:none}.error-strip{grid-template-columns:1fr auto}.error-strip span:nth-child(2){grid-column:1/-1;grid-row:2}.error-main{padding-bottom:var(--atlas-space-8)}.error-footer{flex-direction:column;align-items:flex-start;padding-bottom:calc(var(--atlas-space-8) + env(safe-area-inset-bottom))}.error-footer .atlas-footer__identity,.error-footer .atlas-footer__context,.error-footer .atlas-footer__evidence,.error-footer .atlas-footer__escape{width:100%;flex:0 0 auto;border-left:0;padding-left:0;white-space:normal}}
