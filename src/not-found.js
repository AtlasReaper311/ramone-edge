...
a{color:inherit}
.error-header.atlas-global-header{display:block;padding:0;min-height:56px;background:rgba(10,10,15,.96)}
.error-header .atlas-header__inner{width:min(calc(100% - 48px),1280px);min-height:56px;margin-inline:auto;display:grid;grid-template-columns:minmax(230px,1fr) auto minmax(230px,1fr);align-items:center;gap:24px}
...
.error-header .atlas-global-header__nav{gap:24px}
.error-header .atlas-global-header__link{padding-inline:12px;font-size:12px;letter-spacing:.06em;text-transform:uppercase}
.error-strip{display:grid;grid-template-columns:auto minmax(0,1fr) auto;min-height:44px;align-items:center;gap:var(--atlas-space-3);padding-inline:max(24px,calc((100% - 1280px)/2));border-bottom:1px solid var(--atlas-border);color:var(--atlas-text-dim);font-size:var(--atlas-type-meta);letter-spacing:.08em;text-transform:uppercase}.error-strip strong{color:var(--atlas-accent);font-weight:500}.error-strip span:last-child{color:var(--error)}
...
@media(max-width:767px){.error-header.atlas-global-header{padding:0}.error-header .atlas-header__inner{width:min(calc(100% - 32px),1280px);grid-template-columns:minmax(0,1fr);gap:12px}.error-header .atlas-global-header__nav{display:none}.error-strip{grid-template-columns:1fr auto;padding-inline:16px}.error-strip span:nth-child(2){grid-column:1/-1;grid-row:2}.error-main{padding-bottom:var(--atlas-space-8)}.error-footer{flex-direction:column;align-items:flex-start;padding-bottom:calc(var(--atlas-space-8) + env(safe-area-inset-bottom))}.error-footer .atlas-footer__identity,.error-footer .atlas-footer__context,.error-footer .atlas-footer__evidence,.error-footer .atlas-footer__escape{width:100%;flex:0 0 auto;border-left:0;padding-left:0;white-space:normal}}
